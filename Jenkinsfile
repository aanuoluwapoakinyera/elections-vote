pipeline {
    ...
    environment {
        ...
        EC2_INSTANCE = "ubuntu@15.222.13.153"  // Change to your EC2 public IP
    ...
    stages {
        stage('Checkout Code') {
            steps {
                git branch: 'main', url: 'https://github.com/aanuoluwapoakinyera/elections-vote.git' // Use your own repo
            }
        }
